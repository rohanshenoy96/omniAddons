...
import { OMNIDEF } from './rules_BOPQuoteEnglish_def.js';
import tmpl from './rules_BOPQuoteEnglish.html';
import tmpl_nds from './rules_BOPQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class rules_BOPQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
