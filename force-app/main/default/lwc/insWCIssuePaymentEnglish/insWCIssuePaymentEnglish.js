...
import { OMNIDEF } from './insWCIssuePaymentEnglish_def.js';
import tmpl from './insWCIssuePaymentEnglish.html';
import tmpl_nds from './insWCIssuePaymentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insWCIssuePaymentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
