...
import { OMNIDEF } from './qe_hc_os_SmallGroupQuotingEnglish_def.js';
import tmpl from './qe_hc_os_SmallGroupQuotingEnglish.html';
import tmpl_nds from './qe_hc_os_SmallGroupQuotingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qe_hc_os_SmallGroupQuotingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
