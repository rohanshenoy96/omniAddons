...
import { OMNIDEF } from './vpaExerciseStarterIssuePolicyEnglish_def.js';
import tmpl from './vpaExerciseStarterIssuePolicyEnglish.html';
import tmpl_nds from './vpaExerciseStarterIssuePolicyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vpaExerciseStarterIssuePolicyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
