...
import { OMNIDEF } from './qe_hc_int_InvestigateSmallGroupQuotingEnglish_def.js';
import tmpl from './qe_hc_int_InvestigateSmallGroupQuotingEnglish.html';
import tmpl_nds from './qe_hc_int_InvestigateSmallGroupQuotingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qe_hc_int_InvestigateSmallGroupQuotingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
