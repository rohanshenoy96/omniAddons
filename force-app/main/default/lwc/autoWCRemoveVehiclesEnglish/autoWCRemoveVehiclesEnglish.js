...
import { OMNIDEF } from './autoWCRemoveVehiclesEnglish_def.js';
import tmpl from './autoWCRemoveVehiclesEnglish.html';
import tmpl_nds from './autoWCRemoveVehiclesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoWCRemoveVehiclesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
