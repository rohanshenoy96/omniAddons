...
import { OMNIDEF } from './vpaSampleAutoWC_QuoteEnglish_def.js';
import tmpl from './vpaSampleAutoWC_QuoteEnglish.html';
import tmpl_nds from './vpaSampleAutoWC_QuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vpaSampleAutoWC_QuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
