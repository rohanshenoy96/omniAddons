...
import { OMNIDEF } from './autoWCQuoteEnglish_def.js';
import tmpl from './autoWCQuoteEnglish.html';
import tmpl_nds from './autoWCQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoWCQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
