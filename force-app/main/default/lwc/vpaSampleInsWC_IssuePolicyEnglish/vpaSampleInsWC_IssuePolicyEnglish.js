...
import { OMNIDEF } from './vpaSampleInsWC_IssuePolicyEnglish_def.js';
import tmpl from './vpaSampleInsWC_IssuePolicyEnglish.html';
import tmpl_nds from './vpaSampleInsWC_IssuePolicyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vpaSampleInsWC_IssuePolicyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
