...
import { OMNIDEF } from './qe_hc_rt_TestLabsDentalEnglish_def.js';
import tmpl from './qe_hc_rt_TestLabsDentalEnglish.html';
import tmpl_nds from './qe_hc_rt_TestLabsDentalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qe_hc_rt_TestLabsDentalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
