...
import { OMNIDEF } from './qe_hc_pm_TestLabsVisionEnglish_def.js';
import tmpl from './qe_hc_pm_TestLabsVisionEnglish.html';
import tmpl_nds from './qe_hc_pm_TestLabsVisionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qe_hc_pm_TestLabsVisionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
