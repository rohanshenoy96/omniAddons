...
import { OMNIDEF } from './insWCPolicyOneTimePaymentEnglish_def.js';
import tmpl from './insWCPolicyOneTimePaymentEnglish.html';
import tmpl_nds from './insWCPolicyOneTimePaymentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insWCPolicyOneTimePaymentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
