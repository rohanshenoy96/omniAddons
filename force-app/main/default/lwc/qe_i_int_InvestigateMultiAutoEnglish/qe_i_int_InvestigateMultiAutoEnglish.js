...
import { OMNIDEF } from './qe_i_int_InvestigateMultiAutoEnglish_def.js';
import tmpl from './qe_i_int_InvestigateMultiAutoEnglish.html';
import tmpl_nds from './qe_i_int_InvestigateMultiAutoEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qe_i_int_InvestigateMultiAutoEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
