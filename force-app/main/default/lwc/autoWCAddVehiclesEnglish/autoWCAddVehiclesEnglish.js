...
import { OMNIDEF } from './autoWCAddVehiclesEnglish_def.js';
import tmpl from './autoWCAddVehiclesEnglish.html';
import tmpl_nds from './autoWCAddVehiclesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoWCAddVehiclesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
