...
import { OMNIDEF } from './autoWCModifyCoveragesEnglish_def.js';
import tmpl from './autoWCModifyCoveragesEnglish.html';
import tmpl_nds from './autoWCModifyCoveragesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoWCModifyCoveragesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
