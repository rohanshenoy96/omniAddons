...
import { OMNIDEF } from './insQuoteWrapUpEnglish_def.js';
import tmpl from './insQuoteWrapUpEnglish.html';
import tmpl_nds from './insQuoteWrapUpEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insQuoteWrapUpEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
