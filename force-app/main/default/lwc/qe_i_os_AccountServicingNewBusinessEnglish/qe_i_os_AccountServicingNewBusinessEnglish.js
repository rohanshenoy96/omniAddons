...
import { OMNIDEF } from './qe_i_os_AccountServicingNewBusinessEnglish_def.js';
import tmpl from './qe_i_os_AccountServicingNewBusinessEnglish.html';
import tmpl_nds from './qe_i_os_AccountServicingNewBusinessEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qe_i_os_AccountServicingNewBusinessEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
