...
import { OMNIDEF } from './insWCPolicyCancellationEnglish_def.js';
import tmpl from './insWCPolicyCancellationEnglish.html';
import tmpl_nds from './insWCPolicyCancellationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insWCPolicyCancellationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
